...
const articles: Article[] = [
  ...
  instructor: req.user._id,
    ...
    title: "Building StudyNotion — My MERN Journey",
    excerpt: "My journey of building a full-stack online learning platform and learning how frontend, backend, authentication, database, cloud storage and payments work together.",
    readTime: "8 min read",
    date: "Coming Soon",
    tags: ["React", "Node.js", "Express.js", "MongoDB", "Mongoose", "JWT", "Cloudinary", "Razorpay"],
    github: "https://github.com/Navneet-pratap1027",
    liveLink: "https://study-notion-frontend-kappa-seven.vercel.app/",
    toc: [
      { id: "why-i-built", title: "Why I Built It" },
      { id: "what-i-built", title: "What I Built" },
      { id: "what-i-worked-on", title: "What I Worked On" },
      { id: "challenges", title: "Challenges I Faced" },
      { id: "what-i-learned", title: "What I Learned" },
      { id: "improvements", title: "What I Would Improve" },
    ],
    content: [
      { type: "heading", id: "why-i-built", text: "01 — Why I Built It" },
      { type: "paragraph", text: "I wanted to build something more realistic than small frontend projects. StudyNotion gave me an opportunity to work on a complete full-stack application where the frontend, backend, database, authentication, cloud storage and payments all had to work together." },
      { type: "heading", id: "what-i-built", text: "02 — What I Built" },
      { type: "paragraph", text: "StudyNotion is an online learning platform where users can interact with courses and course-related content." },
      { type: "paragraph", text: "While building it, I worked with:" },
      { type: "list", items: [
        "React frontend",
      ...
      { type: "heading", id: "what-i-worked-on", text: "03 — What I Worked On" },
      { type: "paragraph", text: "One of the main parts of the project was connecting the frontend with the backend through APIs." },
      { type: "paragraph", text: "I worked on authentication, course-related APIs, database models, media uploads and different backend routes." },
      { type: "paragraph", text: "I also learned how different parts of a full-stack application depend on each other. A small backend issue could sometimes affect the frontend, so debugging required checking the complete request flow." },
      { type: "heading", id: "challenges", text: "04 — Challenges I Faced" },
      { type: "paragraph", text: "While developing the project, I faced issues such as:" },
      { type: "list", items: [
        ...
        "CORS configuration",
        "Connecting frontend requests with backend APIs",
      ]},
      { type: "paragraph", text: "These problems helped me understand that full-stack development is not only about writing code. It is also about debugging the complete application flow." },
      { type: "heading", id: "what-i-learned", text: "05 — What I Learned" },
      { type: "paragraph", text: "The biggest thing I learned from StudyNotion was how different technologies work together in a real application." },
      { type: "paragraph", text: "I became more comfortable with:" },
      { type: "list", items: [
        "REST API development",
        "React and frontend-backend communication",
      ...
      { type: "heading", id: "improvements", text: "06 — What I Would Improve" },
      { type: "paragraph", text: "If I continue working on StudyNotion, I would improve:" },
      { type: "list", items: [
        "Input validation",
        "Error handling",
        "Testing",
      ...
      { type: "quote", text: "This project gave me a much better understanding of how a MERN application is structured and how to debug problems across the frontend and backend." },
    ],
  },
  {
    id: 2,
